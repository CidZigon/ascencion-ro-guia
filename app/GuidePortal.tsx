  ...
  return <main className="portal">
    ...
    <section className="workspace">
      <div className="content">
        ...
        {active==="equipment"&&selectedEquip&&<Suspense fallback={<SurfaceLoading label="Abriendo el equipamento…"/>}><ItemCatalog key={`equipo-${selectedEquip.id}`} selectedItemId={selectedItemId} initialQuery="" onSelectItem={selectItem} onOpenMonster={openMonster} scope={{kind:"slot",location:selectedEquip.location,eyebrow:"Equipamento",title:selectedEquip.title,description:selectedEquip.description}}/></Suspense>}
