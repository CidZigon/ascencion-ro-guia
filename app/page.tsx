const modules = [
  { n: "01", icon: "✦", title: "Progresión & EXP", text: "Rutas de leveo, cacerías y quests que realmente valen tu tiempo.", tag: "Empieza aquí", href: "/guia-completa.html#modulo-1" },
  { n: "02", icon: "◇", title: "Accesos & Dungeons", text: "Prerrequisitos, NPC, coordenadas y orden para desbloquear contenido.", tag: "Exploración", href: "/guia-completa.html#modulo-2" },
  { n: "03", icon: "♜", title: "Historias & Lore", text: "El mundo, sus conflictos y las cadenas narrativas más importantes.", tag: "Historia", href: "/guia-completa.html#modulo-3" },
  { n: "04", icon: "⌁", title: "Regional & Standalone", text: "Aventuras independientes organizadas por región y dificultad.", tag: "Quests", href: "/guia-completa.html#modulo-4" },
  { n: "05", icon: "⚔", title: "Jobs & Platinum Skills", text: "Cambios de clase y habilidades especiales, paso a paso.", tag: "Clases", href: "/guia-completa.html#modulo-5" },
  { n: "06", icon: "◆", title: "Equipment & Crafting", text: "Equipo, materiales, refinamiento y fabricación sin perder zeny.", tag: "Progreso", href: "/guia-completa.html#modulo-6" },
  { n: "07", icon: "♛", title: "Endless Tower", text: "Preparación, pisos, MVP y estrategia para llegar más alto.", tag: "Endgame", href: "/guia-completa.html#modulo-7" },
  { n: "08", icon: "♧", title: "Compañeros", text: "Pets, homúnculos y mercenarios con datos Pre-Renewal.", tag: "Sistemas", href: "/guia-completa.html#modulo-8" },
];

const paths = [
  { step: "01", title: "Conoce lo esencial", text: "Empieza con progresión y EXP. Define tu ruta de niveles y evita gastar recursos antes de tiempo.", href: "/guia-completa.html#modulo-1" },
  { step: "02", title: "Elige tu camino", text: "Revisa jobs, platinum skills y equipo para tomar decisiones que acompañen tu estilo de juego.", href: "/guia-completa.html#modulo-5" },
  { step: "03", title: "Abre el mundo", text: "Completa accesos y quests regionales; guarda coordenadas y prerrequisitos mientras avanzas.", href: "/guia-completa.html#modulo-2" },
];
    ...
    <main>
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-art">
          <img className="hero-image" src="/og.png" alt="Portal fantástico de Barras Ro bajo la luna" />
          <span className="image-caption">EL MUNDO DE BARRAS RO · PRE-RENEWAL</span>
      ...
      <section className="guide" id="modulos">
        ...
        <div className="module-grid">{modules.map((m) => <a className="module-card" href={m.href} key={m.n}><div className="module-top"><span className="module-number">{m.n}</span><span className="module-tag">{m.tag}</span></div><span className="module-icon">{m.icon}</span><h3>{m.title}</h3><p>{m.text}</p><span className="module-arrow">→</span></a>)}</div>
      </section>
