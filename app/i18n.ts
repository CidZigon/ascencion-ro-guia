...
export const STRINGS = {
  es: {
    ...
    catalog: {
      ...
      onEquip: "Al equipar", onUnequip: "Al desequipar", restrictions: "Restricciones y banderas",
      ...
      noMap: "Mapa no publicado en esta instantánea",
  ...
  en: {
    ...
    catalog: {
      ...
      onEquip: "On equip", onUnequip: "On unequip", restrictions: "Restrictions and flags",
      ...
      noMap: "Map not published in this snapshot",
