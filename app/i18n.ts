...
export const STRINGS = {
  es: {
    ...
    monsters: {
      ...
      sortEfficiency: "Farm óptimo (EXP total / HP)",
      sortEfficiencyBase: "Mejor EXP base / HP",
      sortEfficiencyJob: "Mejor EXP job / HP",
      matches: "coincidencias", more: "Mostrar 80 más",
      topEfficiencyTitle: (n: number) => `Top ${n} por farm óptimo (EXP base + job / HP)`,
      topEfficiencyTitleBase: (n: number) => `Top ${n} por EXP base / HP`,
      topEfficiencyTitleJob: (n: number) => `Top ${n} por EXP job / HP`,
    ...
    guide: {
      ...
      exploreGuide: "Explorar esta guía",
  ...
  en: {
    ...
    monsters: {
      ...
      sortEfficiency: "Optimal farm (total EXP / HP)",
      sortEfficiencyBase: "Best Base EXP / HP",
      sortEfficiencyJob: "Best Job EXP / HP",
      matches: "matches", more: "Show 80 more",
      topEfficiencyTitle: (n: number) => `Top ${n} by optimal farm (Base + Job EXP / HP)`,
      topEfficiencyTitleBase: (n: number) => `Top ${n} by Base EXP / HP`,
      topEfficiencyTitleJob: (n: number) => `Top ${n} by Job EXP / HP`,
    ...
    guide: {
      ...
      exploreGuide: "Explore this guide",
